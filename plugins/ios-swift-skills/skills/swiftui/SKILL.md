...
description: Write, review, or improve SwiftUI code following best practices for view composition, layout, animations, accessibility, Charts, Liquid Glass, and macOS APIs. Use when building new SwiftUI features, refactoring existing views, reviewing code quality, or adopting modern SwiftUI patterns.
---

# SwiftUI Expert Skill

> **Attribution**: This skill is an adaptation of [SwiftUI-Agent-Skill](https://github.com/AvdLee/SwiftUI-Agent-Skill)
> by [Antoine van der Lee (AvdLee)](https://github.com/AvdLee), licensed under MIT.
> Original version: 2.4.3. Adapted to remove overlap with this template's dedicated
> performance and swift-concurrency skills, and aligned with project MVVM conventions.
> State management and performance have their own skills — this skill focuses on view-level patterns.
...
- Do not enforce specific architectures — project rules handle MVVM conventions
- Follow Apple's Human Interface Guidelines and API design patterns
- Only adopt Liquid Glass when explicitly requested (see `references/liquid-glass.md`)
...
- [ ] Passed values never declared as `@State` (they ignore updates)
